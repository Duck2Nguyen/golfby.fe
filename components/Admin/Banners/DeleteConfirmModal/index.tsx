    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center">
      ...
      <div className="relative mx-4 w-full max-w-[42rem] rounded-2xl bg-white p-6 shadow-2xl">
        ...
        <div className="flex flex-col items-center text-center">
          ...
          <h3 className="mb-2 text-[1.7rem] font-600 text-gray-900">Xác nhận xóa banner</h3>
          <p className="mb-6 text-[1.4rem] leading-relaxed text-gray-500">
            Bạn có chắc chắn muốn xóa banner <span className="font-500 text-gray-900">{displayName}</span>?
