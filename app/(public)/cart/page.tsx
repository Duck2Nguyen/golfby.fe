        ...
        <div className="flex items-center justify-between mb-6">
          ...
          {cartItems.length > 0 && (
            <button
              ...
              className="hidden sm:flex items-center gap-2 px-4 py-2 rounded-xl text-[13px] text-muted-foreground hover:text-destructive hover:bg-destructive/5 transition-all duration-200 font-500"
            >
